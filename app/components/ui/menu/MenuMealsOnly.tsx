    ...
    <div className="flex flex-col ">
      <div
        className={twMerge(
          ...
          mode == "dark"
            ? "bg-gradient-to-b from-[var(--tg-theme-bg-color)] from-10% to-dmain shadow-[0px_5px_5px_rgba(0,0,0,0.8)]"
            : "bg-gradient-to-b from-[white] from-10% to-lmain shadow-[0px_5px_5px_rgba(0,0,0,0.4)]"
        )}
      >
        <Image
          src={logo}
